...
module "AS2-VPC" {
 ...
 # subnets as per the availability zones
  private_subnet_ids = [aws_subnet.AS2_private_subnet_a.id,aws_subnet.AS2_private_subnet_b.id]
  public_subnet_ids  = [aws_subnet.AS2_public_subnet_a.id,aws_subnet.AS2_public_subnet_b.id]
