...
module "AS2-VPC" {
 ...
 # subnets as per the availability zones
  private_subnet = [aws_subnet.AS2_private_subnet_a,aws_subnet.AS2_private_subnet_b]
  public_subnet  = [aws_subnet.AS2_public_subnet_a,aws_subnet.AS2_public_subnet_b]
